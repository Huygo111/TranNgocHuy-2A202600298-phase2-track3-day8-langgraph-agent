...
class AgentState(TypedDict, total=False):
    ...
    Overwritten fields hold the latest workflow decision or payload.
    Annotated list fields are append-only reducers so parallel or repeated node
    updates preserve audit history instead of replacing prior entries.
    """
